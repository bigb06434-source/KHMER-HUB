...
rs.Heartbeat:Connect(function()
    ...
    if settings.fly and lp.Character and lp.Character:FindFirstChild("HumanoidRootPart") then lp.Character.HumanoidRootPart.Velocity = cam.CFrame.LookVector  settings.speed end

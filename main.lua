...
local tl = Instance.new("TextLabel", mf); tl.Text = "KHMER HUB V58"; tl.Size = UDim2.new(1,0,0,45); tl.TextColor3 = Color3.new(1,1,1); tl.BackgroundTransparency = 1; tl.Font = "SourceSansBold"; tl.TextSize = 25; tl.ZIndex = 2
...
cT("C", "Combat", UDim2.new(0,0,0,0)); cT("M", "Move", UDim2.new(0,0,0,40)); cT("V", "Visual", UDim2.new(0,0,0,80)); cT("S", "Misc", UDim2.new(0,0,0,120))
